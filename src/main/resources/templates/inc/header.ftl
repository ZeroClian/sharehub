	...
	<div class="container">
		<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
			<a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
				<img src="/static/images/dailyhub.png" alt="dailyhub" height="38px">
			</a>

			<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"
			    style="margin: 0 auto;">
				<li><a href="/" class="nav-link px-2 link-secondary ">我的收藏</a></li>
				<li><a href="../collect-square.ftl" class="nav-link px-2 link-secondary">收藏广场</a></li>
...
<#--            <#if current.id == -1>-->
<#--				<!--未登录&ndash;&gt;-->
<#--				<a class="btn btn-primary" href="../login.ftl" role="button">登录</a>-->
...
<#--						<li><a class="dropdown-item" href="../collect-edit.ftl">新建收藏</a></li>-->
<#--						<li><a class="dropdown-item" href="#">个人中心</a></li>-->
<#--						<li>-->
<#--							<hr class="dropdown-divider">-->
<#--						</li>-->
<#--						<li><a class="dropdown-item" href="../logout.ftl">注销</a></li>-->
<#--					</ul>-->
<#--				</div>-->
<#--            </#if>-->
		</div>
